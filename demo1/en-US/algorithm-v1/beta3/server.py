    ...
    while True:
        try:
            with hist_lock:
                ...
                spike_risk = min(spike / 2.0, 1.0)  # 2.0 L/min/s = full (to calibrate)
...
<div class="grid">
  ...
  <div class="card">
    ...
    <div class="row" style="margin-top:14px">
      ...
      <div class="mini" style="flex:1"><div class="lb">Power</div><div class="vl" id="powerLbl">0.00 W</div></div>
    </div>
...
let pumpState = 0;
let pumpSpeedPct = 0;
const PUMP_MAX_WATT = 1.25;   // estimated full-load power (5V×250mA), calibrate per nameplate
