...
<div class="grid">
  ...
  <div class="card">
    ...
    <div class="row" style="margin-top:14px">
      ...
      <div class="mini" style="flex:1"><div class="lb">功率</div><div class="vl" id="powerLbl">0.00 W</div></div>
    </div>
...
let pumpState = 0;
let pumpSpeedPct = 0;
const PUMP_MAX_WATT = 1.25;   // 满载功率估算（5V×250mA），按铭牌标定可改
...
function renderPump(){
  ...
  document.getElementById('powerLbl').textContent = (pumpSpeedPct / 100 * PUMP_MAX_WATT).toFixed(2) + ' W';
